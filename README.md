...
- **[datacontract-edit](https://github.com/entropy-data/dataproduct-builder-dbt/blob/main/skills/datacontract-edit/SKILL.md)** edits a `datacontracts/*.odcs.yaml` using natural language.
